...
if __name__ == "__main__":
    ...
    transforms_train = transforms.Compose([
        ...
        transforms.ColorJitter(contrast=(0.6, 1.4)), #, brightness=(0.8, 1.2)),
        transforms.ToTensor(),
...
#        transforms.RandomAffine(random.randint(-15, 15)),
    ...
    transforms_test = transforms.Compose([
        transforms.ToTensor(),
        transforms.ColorJitter(contrast=(1, 1.4)),  # , brightness=(0.8, 1.2)),
        transforms.Normalize(
            [0.485, 0.456, 0.406],
            [0.229, 0.224, 0.225]
        )
    ...
    for epoch in range(1, num_epochs):
        ...
        if epoch >=40:
            ...
            torch.save(model.state_dict({
                ...
                'loss': loss,
            }), 'result_submit3/v4_efficientb7_epoch' + str(epoch) + ".pt")